    ...
    >
        ...
        >
            ...
            @else
                ...
                <div class="min-h-0 flex-1 space-y-3 overflow-y-auto p-2" wire:key="chat-list-{{ md5($contactSearch) }}">
                    <div>
        ...
        >
            ...
            <span
                x-show="! open && {{ $this->unreadTotal > 0 ? 'true' : 'false' }}"
                x-cloak
                class="absolute -top-1 -end-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-rose-500 px-1 text-[11px] font-bold text-white ring-2 ring-white dark:ring-zinc-900"
            >
