    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">HealthPulse</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">A custom-made hospital management solution curated for small to medium setups.</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    ...
                    <li
                        ...
                        <span>
                            Streamline billing, pharmacy, lab & staff workflows
                        </span>
                    </li>
                </ul>
                <ul class="flex gap-3 text-sm leading-normal">
                    ...
                    <li>
                        <a href="{{ route('display.tokens.tv') }}"
                            class="inline-block dark:text-[#EDEDEC] text-[#1b1b18] border border-[#19140035] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:hover:border-[#62605b] px-5 py-1.5 rounded-sm text-sm leading-normal">
                            TV Display
                        </a>
                    </li>
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-[4/3] w-full lg:w-[438px] shrink-0 overflow-hidden">
                <img src="{{ asset('imgs/mr.png') }}" class="w-full h-full object-cover" alt="Description of image">
